define(['SpecHelpers', './Model'], function(_arg, Model) {
  ...
  return function(_arg2) {
    var Nav, NavOnChange, currentHash, loadModule, mAppConfig, mHashDelegate, mInitialHash, mockModules;
    ...
    it('sets Nav.current to the parsed initial hash (HashDelegate.get())', function() {
